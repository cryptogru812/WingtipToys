...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-q8cyg38405610@business.example.com";
    private string APIPassword = "gd|5G%Yf";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:56614/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:56614/Checkout/CheckoutCancel.aspx";
